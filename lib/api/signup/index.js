...
app.post('/signup', function (req, res) {
  ...
  api.padron.isInPadron(profile.dni).then(padron => {
    if (padron){
      ...
      return res.status(200).json({ error: 'Tu DNI no se encuentra en el padrón. Revisá si tu DNI es el correcto o completá <a href="https://forms.gle/wtBQYfDQah6XsXT48" target="_blank">este formulario</a> con tus datos' })
  })
})
