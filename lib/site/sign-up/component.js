            ...
            <div id='signup-form'>
              ...
              <FormAsync
                  ...
                  <select
                    ...
                    {facultades.length > 0 && facultades.map(facultad =>
                      <option key={facultad._id} value={facultad._id}>
                        {facultad.abreviacion} - {facultad.nombre}
                      </option>
                    )}
                  </select>
                </div>
                ...
                <div className='form-group'>
                  ...
                  <p className="help-text"><i className="icon-info icon-large"></i> <u>Ser proyectista</u> implica transformar las ideas en proyectos. Podes informarte más acerca de que es ser proyectista en la sección de <Link href="/s/acerca-de?q=proyectista">Información</Link></p>                </div>
                }
                <div className='form-group'>
